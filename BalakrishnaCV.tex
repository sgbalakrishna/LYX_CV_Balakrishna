...
{\small{}}%
\begin{tabular}{cl}
\includegraphics[scale=0.05]{pasted9} & {\small{}Turnackerstr 19, 70794, Filderstadt, Germany.}\tabularnewline
\includegraphics[scale=0.05]{pasted8} & {\small{}balakrishnasg@daimler.com}\tabularnewline
...
for online leads.
\begin{itemize}
\item Built automated ensemble prediction models with various machine learning
