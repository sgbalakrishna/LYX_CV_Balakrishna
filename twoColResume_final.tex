...
{\footnotesize{}Title, Family Name, First Name}{\footnotesize \par}

\rule[0.5ex]{1\linewidth}{0.02pt}
\begin{flushleft}
\textbf{\large{}Dr. Soorali Ganeshamurthy, Balakrishna}
\par\end{flushleft}{\large \par}%
\end{minipage}
\par\end{flushleft}{\Large \par}
...
{\small{}\includegraphics[scale=0.035]{pasted2}\hspace*{0.3cm}balakrishna@web.de}{\small \par}

{\small{}\includegraphics[scale=0.045]{pasted3}\hspace*{0.3cm}+49
(0) 176-3096-2464}{\small \par}

{\small{}\includegraphics[scale=0.06]{Birthday_Icon}\hspace*{0.3cm}
21.August.1983}{\small \par}

{\small{}\includegraphics[scale=0.017]{tls-boca-systems-icon-world-thumb}\hspace*{0.3cm}
Indian}{\small \par}%
...
\textbf{Ph.D. Applied Physics} - University of Saarland (UDS), Saarbrücken,
Germany. 
\par\end{flushleft}
\item \begin{flushleft}
...
für neue Materialien, Saarbrucken, Germany.}}
\par\end{flushleft}
\begin{itemize}
...
\begin{minipage}[t]{0.8\linewidth}%
\begin{flushleft}
\textbf{\textcolor{black}{PhD student, INM - Leibniz Institut für
